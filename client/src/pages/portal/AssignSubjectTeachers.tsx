...
import { Search, Users, BookOpen, Plus, Trash2, Loader2, GraduationCap, User } from 'lucide-react';
                    ...
                    <DialogContent className="max-w-lg">
                      ...
                      <DialogFooter>
                        ...
                        <Button
                          ...
                          disabled={selectedClasses.length === 0 || selectedSubjects.length === 0 || createAssignmentMutation.isPending}
