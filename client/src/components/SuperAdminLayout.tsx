  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Students", path: "/portal/superadmin/users/students" },
        { label: "Teachers", path: "/portal/superadmin/users/teachers" },
        { label: "Parents", path: "/portal/superadmin/users/parents" },
        { label: "Admins", path: "/portal/superadmin/admins" },
        { label: "Roles & Permissions", path: "/portal/superadmin/users/roles" },
        { label: "Login Access Control", path: "/portal/superadmin/users/access-control" },
      ],
    },
    {
      label: "Academics",
      icon: GraduationCap,
      children: [
        { label: "Classes & Levels", path: "/portal/superadmin/academics/classes" },
        { label: "Subjects", path: "/portal/superadmin/academics/subjects" },
        { label: "Timetable", path: "/portal/superadmin/academics/timetable" },
        { label: "Attendance Setup", path: "/portal/superadmin/academics/attendance" },
        { label: "Curriculum", path: "/portal/superadmin/academics/curriculum" },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: ClipboardList,
      children: [
        { label: "Exam Setup", path: "/portal/superadmin/results/exams" },
        { label: "Continuous Assessment", path: "/portal/superadmin/results/ca" },
        { label: "Grade Boundaries", path: "/portal/superadmin/results/grades" },
        { label: "Result Processing", path: "/portal/superadmin/results/processing" },
        { label: "Result Publishing", path: "/portal/superadmin/results/publishing" },
      ],
    },
    {
      ...
      icon: Building,
      children: [
        { label: "Departments", path: "/portal/superadmin/operations/departments" },
        { label: "School Calendar", path: "/portal/superadmin/operations/calendar" },
        { label: "Events & Notices", path: "/portal/superadmin/operations/events" },
        { label: "Sessions & Terms", path: "/portal/superadmin/operations/sessions" },
        { label: "Promotion Settings", path: "/portal/superadmin/operations/promotions" },
      ],
    },
    {
      label: "Finance",
      icon: DollarSign,
      children: [
        { label: "Fees Setup", path: "/portal/superadmin/finance/fees" },
        { label: "Payment Records", path: "/portal/superadmin/finance/payments" },
        { label: "Fee Categories", path: "/portal/superadmin/finance/categories" },
        { label: "Discounts & Waivers", path: "/portal/superadmin/finance/discounts" },
        { label: "Transactions", path: "/portal/superadmin/finance/transactions" },
      ],
    },
    {
      label: "Communication",
      icon: MessageSquare,
      children: [
        { label: "SMS Settings", path: "/portal/superadmin/communication/sms" },
        { label: "Email Settings", path: "/portal/superadmin/communication/email" },
        { label: "Notifications", path: "/portal/superadmin/communication/notifications" },
        { label: "Messaging Logs", path: "/portal/superadmin/communication/logs" },
        { label: "Templates", path: "/portal/superadmin/communication/templates" },
      ],
    },
    {
      label: "Content",
      icon: FileText,
      children: [
        { label: "Assignments", path: "/portal/superadmin/content/assignments" },
        { label: "Lesson Notes", path: "/portal/superadmin/content/lessons" },
        { label: "E-Library", path: "/portal/superadmin/content/library" },
        { label: "File Manager", path: "/portal/superadmin/content/files" },
      ],
    },
    {
      ...
      children: [
        ...
        { label: "Branding", path: "/portal/superadmin/settings/branding" },
        { label: "API Keys", path: "/portal/superadmin/settings/api-keys" },
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Login History", path: "/portal/superadmin/audit/login-history" },
        { label: "Activity Tracking", path: "/portal/superadmin/audit/activity" },
        { label: "Error Logs", path: "/portal/superadmin/audit/errors" },
        { label: "Access Violations", path: "/portal/superadmin/audit/violations" },
      ],
    },
    {
      label: "Support",
      icon: LifeBuoy,
      children: [
        { label: "Help Requests", path: "/portal/superadmin/support/requests" },
        { label: "Tickets", path: "/portal/superadmin/support/tickets" },
        { label: "Documentation", path: "/portal/superadmin/support/docs" },
        { label: "FAQ", path: "/portal/superadmin/support/faq" },
      ],
    },
    {
      ...
      icon: Terminal,
      children: [
        { label: "Database Schema", path: "/portal/superadmin/developer/schema" },
        { label: "API Playground", path: "/portal/superadmin/developer/api" },
        { label: "Webhooks", path: "/portal/superadmin/developer/webhooks" },
        { label: "Environment", path: "/portal/superadmin/developer/environment" },
      ],
    },
    {
      label: "Account",
      ...
      children: [
        ...
        { label: "Change Password", path: "/portal/superadmin/account/password" },
      ],
    },
  ];
