...
// Shared schema for creating students - SIMPLIFIED AUTO-GENERATION MODE
// email, password, and admissionNumber are ALWAYS auto-generated by system
export const createStudentSchema = z.object({
  // User fields - all auto-generated (email, password, username)
  firstName: z.string().min(1, "First name is required"),
  lastName: z.string().min(1, "Last name is required"),
  phone: z.string().optional(),
  address: z.string().optional(),
